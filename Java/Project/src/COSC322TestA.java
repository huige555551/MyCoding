...
public class COSC322TestA implements GamePlayer{
	...
	public static void main(String[] args) {
		...
		COSC322TestA client = new COSC322TestA(user, pass); 
		ArrayList<GameRoom> gameRoomList = client.gameClient.getRoomLists();
		
		for(GameRoom g:gameRoomList){
			System.out.println("Room ID = " + g.roomID);
			System.out.println("Room Name = " + g.roomName);
			System.out.println("User Count = " + g.userCount + "\n");
		}
	}
